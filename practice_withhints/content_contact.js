...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/cont1.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/cont2.mp3');
var audio2 = new Audio('http://home.ustc.edu.cn/~wyc0807/cont3.mp3')
var audio3 = new Audio('http://home.ustc.edu.cn/~wyc0807/cont4.mp3');
var audio4 = new Audio('http://home.ustc.edu.cn/~wyc0807/cont5.mp3');
...
//a_goal4.style.color = "black";
//e_goal7.style.backgroundColor = "yellow";
...
//a_goal4.style.color = "black";
e_goal8.style.backgroundColor = "yellow";
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "Contact Information:"){
  audio1.pause();
  open.load();
  open.play();
  document.getElementsByClassName("address")[0].style.border = "5px solid white";
  document.getElementById("anch_65").style.border = "5px solid white";
  //var audio = new Audio('http://home.ustc.edu.cn/~wyc0807/main feature.mp3');
  //audio.autoplay = true;
  //audio.load();
}
  else if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "It is a good sign if a website sponsor provides you with information, such as physical address, phone numbers, and inquiry forms."){
  open.pause();
  audio2.pause();
  audio1.load();
  audio1.play();
  ...
  else if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "Many websites have a Contact Us link somewhere on the homepage, but MedlinePlus is brought to you by a bigger organization, the NIH: National Library of Medicine, so for contact information we will need to visit that organization's webpage."){
  audio1.pause();
  audio3.pause();
  audio2.load();
  audio2.play();
...
document.addEventListener("click", function(){
	//alert(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML);
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Notice there is both a physical address and links to the website sponsors at the bottom of the page."){
  ...
  document.getElementById("anch_65").style.border = "5px solid white";}
  else if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Click on the link for the U.S. National Library of Medicine to go to their website."){
  //var audio = new Audio('http://home.ustc.edu.cn/~wyc0807/cate.mp3');
  //audio.autoplay = true;
  //audio.load();
  ...
  audio4.play();
  document.getElementsByClassName("address")[0].style.border = "5px solid white";
  document.getElementById("anch_65").style.border = "5px solid red";}
