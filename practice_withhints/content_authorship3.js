...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/aut6.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/aut7.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "You have arrived at the Falls information page. Please take a moment to read over the Summary."){
  ...
  open.load();
  open.play();}
  else if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Notice that the information is provided by the NIH: National Institute on Aging."){
  //var audio = new Audio('http://home.ustc.edu.cn/~wyc0807/cate.mp3');
  //audio.autoplay = true;
  //audio.load();
  open.pause();
  audio1.load();
  audio1.play();
  document.getElementsByClassName("attribution")[0].style.border = "5px solid red";}
