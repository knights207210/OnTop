...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/rev3.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/rev4.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Take a few moments to read over the MedlinePlus Quality Guidelines."){
  ...
  open.load();
  open.play();}
  else if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Also take note of the Quality, authority and accuracy of health content section."){
  open.pause();
  audio1.load();
  audio1.play();
  }
