var open = new Audio('http://home.ustc.edu.cn/~wyc0807/reshi.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/plreshi.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "You are now on the web page with information about Reishi Mushrooms."){
...
document.addEventListener("click", function(){
  //alert(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML);
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Notice the table of contents"){
