...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/aut1.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/aut2.mp3');
var audio2 = new Audio('http://home.ustc.edu.cn/~wyc0807/aut3.mp3')
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "Authorship:"){
  audio1.pause();
  open.load();
  open.play();
  ...
  else if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "To find authorship of posts on MedlinePlus, let's find an article on Falls."){
  open.pause();
  audio2.pause();
  audio1.load();
  audio1.play();
...
document.addEventListener("click", function(){
	//alert(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML);
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "First, click on Health Topics."){
  ...
  document.getElementsByClassName("category-nav-area home-section")[0].style.border = "5px solid red";}
