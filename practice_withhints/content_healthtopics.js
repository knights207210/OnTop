...
instruction_healthtopic.innerText="click on letter 'D' to find all health topics start with 'D'";
//a_backtohome.innerText.style.border = '5px solid red';
...
instruction_healthtopic.style.top = '420px';
instruction_healthtopic.style.left = '100px';
};