...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/pur1.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/pur2.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "Purpose:"){
  audio1.pause();
  open.load();
  open.play();
...
document.addEventListener("click", function(){
	//alert(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML);
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "To identify the purpose of MedlinePlus, click the About MedlinePlus link at the top of the screen again."){
  ...
  audio1.load();
  audio1.play();
  document.getElementById("anch_9").style.border = "5px solid red";}
