...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/aut4.mp3');
...
//var open = new Audio('http://home.ustc.edu.cn/~wyc0807/main feature.mp3');
  ...
  open.load();
  open.play();
  document.getElementById("anch_28").style.border = "5px solid red";
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Next, click on the letter F for Falls."){
