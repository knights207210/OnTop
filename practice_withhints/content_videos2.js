...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/vt2.mp3');
...
//var open = new Audio('http://home.ustc.edu.cn/~wyc0807/main feature.mp3');
  ...
  open.load();
  open.play();
  document.getElementsByClassName("section-body no-header av_icon")[0].style.border = "5px solid red";
...
//a_goal4.style.color = "black";
a_goal8.style.backgroundColor = "yellow";
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "You are now on the Videos & Tools page. For videos on various health topics, click on the link for Health Videos."){
