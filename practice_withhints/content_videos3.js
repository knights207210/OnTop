...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/vt3.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "You are now on the Health Videos page. To watch a cool video about blinking, click the link for blinking."){
