...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/tfiothr.mp3');
...
//a_goal4.style.color = "black";
a_goal6.style.backgroundColor = "yellow";
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "To find information on healthy recipes, you can click the Healthy Recipes link at the bottom of the page."){
