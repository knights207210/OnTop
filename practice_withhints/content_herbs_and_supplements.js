var open = new Audio('http://home.ustc.edu.cn/~wyc0807/tf.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "To find information on Herbs and Supplements, first click on the Drugs and Supplements link."){
