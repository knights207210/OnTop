...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/pur3.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/pur4.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Take a moment to read over the following paragraphs."){
  ...
  open.load();
  open.play();}
  else if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "After reading these paragraphs, you can see the purpose of MedlinePlus and decide if it is both relevant and trustworthy."){
  open.pause();
  audio1.load();
  audio1.play();
  }
