var open = new Audio('http://home.ustc.edu.cn/~wyc0807/yanot.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/yanot1.mp3');
window.onload = function(){
//var open = new Audio('http://home.ustc.edu.cn/~wyc0807/main feature.mp3');
  //open.autoplay = true;
  open.load();
  open.play();
  document.getElementById("anch_39").style.border = "5px solid red";
  document.getElementById("anch_183").style.border = "5px solid white";
...
a_goal5.style.backgroundColor = "yellow";
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "You are now on the Herbs and Supplements page"){
  ...
  audio.autoplay = true;
  audio.load();}*/
  else if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Find the link for Reishi Mushroom and click on it."){
  ...
  audio1.load();
  audio1.play();
  document.getElementById("anch_39").style.border = "5px solid white";
  document.getElementById("anch_183").style.border = "5px solid red";}
}, false);
