...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/upd1.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/upd2.mp3');
var audio2 = new Audio('http://home.ustc.edu.cn/~wyc0807/upd3.mp3')
var audio3 = new Audio('http://home.ustc.edu.cn/~wyc0807/upd4.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "Updates:"){
  audio1.pause();
  open.load();
  open.play();
  document.getElementsByClassName("date")[0].style.border = "5px solid white";
  //var audio = new Audio('http://home.ustc.edu.cn/~wyc0807/main feature.mp3');
  //audio.autoplay = true;
  //audio.load();
}
  else if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "We are still at the Falls page in Goal 4. At the bottom of the Falls page you will find the date when the webpage was last updated."){
  open.pause();
  audio2.pause();
  audio1.load();
  audio1.play();
...
document.addEventListener("click", function(){
	//alert(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML);
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Notice the dates for:"){
  ...
  audio2.load();
  audio2.play();
  document.getElementsByClassName("date")[0].style.border = "5px solid red";}
  else if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Note: Most websites include update information at the bottom of a page or the end of an article."){
    audio2.pause();
  audio3.load();
  audio3.play();
  document.getElementsByClassName("date")[0].style.border = "5px solid red";
