...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/pri1.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "Privacy Policy:"){
  audio1.pause();
  open.load();
  open.play();
  document.getElementById("anch_59").style.border = "5px solid white";
  //var audio = new Audio('http://home.ustc.edu.cn/~wyc0807/main feature.mp3');
  //audio.autoplay = true;
  //audio.load();
}
  else if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "On the MedlinePlus homepage, as with most websites, you can find information about the privacy policy at the bottom of the homepage."){
  open.pause();
  audio2.pause();
  audio1.load();
  audio1.play();
...
document.addEventListener("click", function(){
	//alert(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML);
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Click on the Privacy Policy link located at the bottom of the MedlinePlus Homepage."){
  ...
  audio2.load();
  audio2.play();
  document.getElementById("anch_59").style.border = "5px solid red";}
