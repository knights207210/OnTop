...
scrolldown.innerText="Scroll down to find 'Aspirin'";
//a_backtohome.innerText.style.border = '5px solid red';
...
scrolldown.style.top = '120px';

document.getElementById("anch_568").style.border = "5px solid red";

var instruction_healthtopic=document.createElement("a");
instruction_healthtopic.innerText="click on 'Aspirin'";
//a_backtohome.innerText.style.border = '5px solid red';
...
instruction_healthtopic.style.top = '17850px';
