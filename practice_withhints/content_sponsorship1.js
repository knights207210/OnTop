...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/sp3.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/sp4.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Take a moment to read over the first paragraph."){
  ...
  open.load();
  open.play();}
  else if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "After reading this paragraph, we can see that MedlinePlus is brought to you and funded by the National Institute of Health"){
  open.pause();
  audio1.load();
  audio1.play();
  }
