...
//if(title == "Medline Plus Tutorial"){
    ...
    //audio.load();
//}
var open = new Audio('http://home.ustc.edu.cn/~wyc0807/healthyproviders1.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/healthy-providers2.mp3');
...
//a_goal4.style.color = "black";
a_goal7.style.backgroundColor = "yellow";
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "To find information on healthcare providers, look for the Directories link at the bottom of this page."){
  audio1.pause();
  open.load();
  open.play();
...
document.addEventListener("click", function(){
	//alert(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML);
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Click on the Directories link"){
  ...
  audio1.load();
  audio1.play();
  document.getElementById("anch_46").style.border = "5px solid red";}
}, false);
