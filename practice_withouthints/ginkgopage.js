var open = new Audio('http://home.ustc.edu.cn/~wyc0807/nyaotpog.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/tig.mp3');
...
//var open = new Audio('http://home.ustc.edu.cn/~wyc0807/main feature.mp3');
  ...
  open.load();
  open.play();
  document.getElementById("page-title").style.border = "5px solid red";
};
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == "Now you are on the page of Ginkgo"){
  audio1.pause();
  open.load();
  open.play();
  ...
  //audio.load();
  document.getElementById("page-title").style.border = "5px solid red";
  document.getElementsByClassName("onpage")[1].style.border = "5px solid white";
  
}
  else if(document.getElementsByClassName("nickelled__step__title nickelled__component__title")[0].innerHTML == 'There is a table of contents with links of different information about the supplement'){
  ...
  document.getElementsByClassName("onpage")[1].style.border = "5px solid red";
  //document.getElementsByClassName("address")[0].style.border = "5px solid white";
  document.getElementById("page-title").style.border = "5px solid white";
