var open = new Audio('http://home.ustc.edu.cn/~wyc0807/nwwmtongs.mp3');
var audio1 = new Audio('http://home.ustc.edu.cn/~wyc0807/ginkgo.mp3');
...
document.addEventListener("click", function(){
  ...
  if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == "How to find information on supplements"){
  audio1.pause();
  open.load();
  open.play();
  ...
  else if(document.getElementsByClassName("nickelled__slide__title nickelled__component__title")[0].innerHTML == 'For example, if we want to find a supplement "Ginkgo"'){
